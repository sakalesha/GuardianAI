...
*   **Response Structure (200 OK):**
    ```json
    {
      ...
      "alert": {
        ...
        "severity": "Medium",
        "aiConfidence": 0.82,
        "mediaUrl": "https://res.cloudinary.com/CLOUD_NAME_REMOVED/image/upload/v1234/guardianai/alerts/img.jpg",
        "mlMetadata": {
          "detectedIssues": [
            {
    ...
    [
      {
        ...
        "severity": "Medium",
        "status": "PENDING",
        "mediaUrl": "https://res.cloudinary.com/CLOUD_NAME_REMOVED/image/upload/v1234/...",
        "createdAt": "2026-06-02T08:00:00.000Z"
      }
    ]
    ```
...
*   **Response Structure (200 OK - Successful Resolution):**
    ```json
    {
      ...
      "alert": {
        "_id": "6915d600b8623838c7f8291b",
        "status": "RESOLVED",
        "resolutionImageUrl": "https://res.cloudinary.com/CLOUD_NAME_REMOVED/image/upload/v1234/guardianai/resolutions/repaired.jpg",
...
*   **Request Body (JSON):**
    ```json
    {
      "image": "https://res.cloudinary.com/CLOUD_NAME_REMOVED/image/upload/v1234/guardianai/alerts/img.jpg"
    }
    ```
*   **Response Structure (200 OK):**
    ```json
...
*   **Request Body (JSON):**
    ```json
    {
      "beforeImage": "https://res.cloudinary.com/CLOUD_NAME_REMOVED/image/upload/v1234/guardianai/alerts/before.jpg",
      "afterImage": "https://res.cloudinary.com/CLOUD_NAME_REMOVED/image/upload/v1234/guardianai/resolutions/after.jpg"
    }
    ```
*   **Response Structure (200 OK):**
    ```json
